      ...
      <div className="container p-4 bg-white mx-auto px-4 rounded-2xl mt-2">
        <div className="flex flex-col lg:flex-row justify-between items-center gap-18">
          ...
          <div className="flex-1 max-w-md">
            ...
            <div className="space-y-1 text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
              <h2 className="font-medium">
                تبدیل عکس به پی‌دی‌اف — سریع، آنلاین و رایگان برای ساخت PDF از
                تصاویر
              </h2>

              <h2 className="font-medium">
                تبدیل چند عکس به یک فایل PDF آنلاین — ترکیب و ادغام تصاویر در یک
                پی‌دی‌اف
              </h2>

              <h2 className="font-medium">
                تبدیل عکس به PDF با کیفیت بالا — بهترین ابزار تبدیل تصویر به
                فایل پی‌دی‌اف
              </h2>
            </div>
          </div>
